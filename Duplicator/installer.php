...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200925_iqrfoundation_b4abbc470f0fc5931546_20200925041434_archive.zip';
	const ARCHIVE_SIZE		 = '59682430';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b4abbc4-25041434';
    const SECONDARY_PACKAGE_HASH = '16862e6-25041434';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.38==');
		self::log('----------------------------------------------------');
